...
namespace Descope.Management
{
        ...
        IUsersApiClient users) : IManagementApiClient
    {
        ...
        private readonly ITestUsersApiClient _testUsersApiClient = testUsers;
        ...
        public ITestUsersApiClient TestUsers => _testUsersApiClient;
